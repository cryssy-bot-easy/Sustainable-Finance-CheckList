...
public class DepartmentUpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Department> department = depserv.getDepartment(depid);

            json.put("res", depserv.update(depid, depname).toString());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DepartmentUpdateServlet.class.getName()).log(Level.SEVERE, null, ex);
