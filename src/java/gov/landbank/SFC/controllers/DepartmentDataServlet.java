 ...
 * @author F862
 */
@WebServlet(name = "DepartmentDataServlet", urlPatterns = {"/DepartmentDataServlet"})
public class DepartmentDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            json.put("res", new JSONArray(depserv.getAll()));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DepartmentDataServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
