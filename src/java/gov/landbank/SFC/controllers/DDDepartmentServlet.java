 ...
 * @author F862
 */
@WebServlet(name = "DDDepartmentServlet", urlPatterns = {"/DDDepartmentServlet"})
public class DDDepartmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            json.put("res", new JSONArray(depserv.getList()));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DDDepartmentServlet.class.getName()).log(Level.SEVERE, null, ex);
