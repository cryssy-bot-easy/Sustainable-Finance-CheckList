 ...
 * @author F862
 */
@WebServlet(name = "DepartmentDeleteServlet", urlPatterns = {"/DepartmentDeleteServlet"})
public class DepartmentDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            json.put("res", depserv.delete(depid).toString());
            /*
            String status = json.get("res").toString();
            UserActivityService uaserv = new UserActivityService(conn);

            if (status.equals("deleted")) {
                uaserv.create(createdby.toUpperCase(), "delete", "CL_DEPARTMENT", "DEP_ID", "", "", depid, activestat);
            }                        
            */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DepartmentDeleteServlet.class.getName()).log(Level.SEVERE, null, ex);
