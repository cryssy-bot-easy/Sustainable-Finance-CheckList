            ...
            <form id="logout-form" action="/SFC/logout" method="POST">
                ...
                <div id="app-header-nav">
                    <span id="app-user-details">
                        ...
                        <!-- Logout link -->
                        <span id="app-logout">Logout</span>
                    </span>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-around">
                    <div id="reportFormatPdf" class="text-center">
                        <img src="${pageContext.request.contextPath}/images/modal/pdf-icon.png" alt="PDF Icon" className="img-fluid" />
                        <label>PDF</label>
                    </div>
                    <div id="reportFormatExcel" class="text-center">
                        <img src="${pageContext.request.contextPath}/images/modal/xls-icon.png" alt="Excel Icon" className="img-fluid" />
                        <label>Excel</label>
                    </div>
                    <div id="reportFormatWord" class="text-center">
                        <img src="${pageContext.request.contextPath}/images/modal/msword-icon.png" alt="Word Icon" className="img-fluid" />
                        <label>Word</label>
                    </div>
                </div>
            </div>
            ...
            <div id="accordion">
                ...
                <div>
                    <div id="divlovmaintenance">  
                        <form action="/SFC/ViewUserMaintenance" method = "POST"> 
                            <input type="hidden" id="username" name="username" value ="<%= session_user%>" >
                            <input type="hidden" id="isadmin" name="isadmin" value ="<%= session_isadmin%>" >
                            <!--<input type='submit' name="bmaintenancepage" id="bmaintenancepage" class="col-1-4" value="User Maintenance Page">-->
                            
                            <a id="CLdivView" style="cursor: pointer;" onclick="document.getElementById('bmaintenancepage').click();">User Maintenance Page</a>
                            <input type='submit' name="bmaintenancepage" id="bmaintenancepage"  style="display: none;">
                        </form>                                                                            
                    </div>                    
                </div>    
                <h3><a id="accordiontools">E&S Sustainable Finance and Compliance Assessment</a></h3>
                <div>
                    <a id="CLdivView">E&S Sustainable Finance and Compliance Assessment Module</a> 
                </div>
                <h3><a id="accordiontools">Reports</a></h3>
                <div>                          
                    <form action="/SFC/ViewReports" method = "POST"> 
                        <input type="hidden" id="username" name="username" value ="<%= session_user%>" >
                        <a for="breportspage" id="CLdivView" style="cursor: pointer;" onclick="document.getElementById('breportspage').click();">Reports Page</a>
                        <input type='submit' name="breportspage" id="breportspage"  style="display: none;">
                    </form>                                     
                </div>                                               
            </div>    
            <br>
            <input type="hidden" id="sisadmin" name="sisadmin" value ="<%= session_isadmin%>"> 
            <input type="hidden" id="sisactive" name="sisactive" value ="<%= session_isadmin%>">
            <input type="hidden" id="sroleid" name="sroleid" value ="<%= session_isadmin%>"> 
            <input type="hidden" id="sdepid" name="sdepid" value ="<%= session_isadmin%>">             
            <input type="hidden" id="depid" name="depid">        
            <input type="hidden" id="teamid" name="teamid">                        
            <input type="hidden" id="depdesc" name="depdesc">   
        </div>
...
<!--    <div className="modal fade" tabIndex="-1" role="dialog" aria-hidden="false">
        <div className="modal-dialog centered" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div class="flex-row">
                                    <div id="reportFormatPdf" class="flex-8 pdfImage">
                                        <img src={Pdf} alt="pdf"/>
                                        <img src="../images/modal/pdf-icon.png" alt=""/>
                                        <label>Pdf</label>
                                    </div>
                                    <div id="reportFormatExcel" class="flex-8 excelImage">
                                        <img src={Excel} alt="excel"/>
                                        <img src="../images/modal/xls-icon.png" alt=""/>
                                        <label>Excel</label>
                                    </div>
                                    <div id="reportFormatWord" class="flex-8 wordImage">
                                        <img src={} alt="word" />
                                        <img src="../images/modal/msword-icon.png" alt=""/>
                                        <label>Word</label>
                                    </div>
                                </div>
                            </div>
